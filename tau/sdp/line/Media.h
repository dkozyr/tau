...
public:
    ...
    static etl::vector<uint8_t, kMaxCodecs> GetFmts(const etl::string_view& value); //TODO: revise this limit
...
class MediaWriter {
public:
    static etl::string_stream& Write(etl::string_stream& ss, MediaType type, uint16_t port, etl::string_view protocol, const etl::vector<uint8_t, kMaxCodecs>& fmts);
};
