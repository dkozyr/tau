...
etl::string_view ByteStringReader::GetValue(const BufferViewConst& view) {
    return etl::string_view{reinterpret_cast<const char*>(view.ptr + kAttributeHeaderSize), view.size - kAttributeHeaderSize};
}
...
bool ByteStringWriter::Write(Writer& writer, AttributeType type, etl::string_view value) {
